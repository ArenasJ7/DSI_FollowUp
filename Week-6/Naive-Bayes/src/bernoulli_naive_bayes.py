...
class BernoulliNaiveBayes(object):
    ...
    def _compute_likelihoods(self, X, y):
        ...
        '''
        for doc, class_email in zip(X, y):
            
            self.class_counts[class_email] += 1
            
            for word in set(doc):
            
                self.class_feature_counts[class_email][word] += 1
    ...
    def word_likelihood(self, word, label):
        ...
        denominator = (self.alpha * 2) + self.class_counts[label]
        ...
        for doc in X:
            ...
            for label in self.class_counts:
                ...
                for word in self.vocab:
                    ...
                    word_prob = self.word_likelihood(word, label)
